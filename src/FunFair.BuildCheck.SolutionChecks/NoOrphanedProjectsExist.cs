...
public sealed class NoOrphanedProjectsExist : ISolutionCheck
{
    ...
    {
        return Directory
            .EnumerateFiles(path: basePath, searchPattern: "*.csproj", searchOption: SearchOption.AllDirectories)
            .Where(IsNotAutoGenerated);
    }

    private static bool IsNotAutoGenerated(string fileName)
    {
        return !fileName.EndsWith(".Autogenerated.csproj", StringComparison.OrdinalIgnoreCase);
    }
