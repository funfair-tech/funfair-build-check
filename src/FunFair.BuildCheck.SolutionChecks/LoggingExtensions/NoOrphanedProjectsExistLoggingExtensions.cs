...
internal static partial class NoOrphanedProjectsExistLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 2,
        Level = LogLevel.Error,
        Message = "{solutionFileName}: Project {projectFileName} is not in solution, but in work folder"
    )]
    public static partial void ProjectIsNotInSolutionButInWorkFolder(
        this ILogger<NoOrphanedProjectsExist> logger,
        string solutionFileName,
