...
internal static partial class GlobalJsonMustNotAllowPreReleaseLoggingExtensions
{
    ...
    public static partial void UsingIncorrectPreReleasePolicy(this ILogger<GlobalJsonMustNotAllowPreRelease> logger,
    ...
    public static partial void FailedToReadGlobalJson(this ILogger<GlobalJsonMustNotAllowPreRelease> logger,
                                                      string solutionFileName,
                                                      string file,
                                                      string message,
                                                      Exception exception);
