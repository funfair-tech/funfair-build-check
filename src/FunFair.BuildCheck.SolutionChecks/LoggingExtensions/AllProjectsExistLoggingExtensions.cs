...
internal static partial class AllProjectsExistLoggingExtensions
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Error, Message = "{solutionFileName}: Project {projectFileName} does not exist")]
    public static partial void ProjectDoesNotExist(this ILogger<AllProjectsExist> logger, string solutionFileName, string projectFileName);
}