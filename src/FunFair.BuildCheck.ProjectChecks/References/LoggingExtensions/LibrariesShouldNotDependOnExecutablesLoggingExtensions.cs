...
internal static partial class LibrariesShouldNotDependOnExecutablesLoggingExtensions
{
    [LoggerMessage(
        ...
        Message = "{projectName}: Library references executable {referencedProject}."
    )]
    public static partial void LibraryReferencesExecutable(
        this ILogger<LibrariesShouldNotDependOnExecutables> logger,
        string projectName,
