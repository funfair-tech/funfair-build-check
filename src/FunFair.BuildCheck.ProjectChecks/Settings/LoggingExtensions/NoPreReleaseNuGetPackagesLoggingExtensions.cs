...
internal static partial class NoPreReleaseNuGetPackagesLoggingExtensions
{
    ...
    [LoggerMessage(
        ...
        Message = "{projectName}: Package {packageId} could not parse version {version}."
    )]
    public static partial void CouldNotParseVersion(
        this ILogger<NoPreReleaseNuGetPackages> logger,
        string projectName,
        string packageId,
        string version
    ...
    [LoggerMessage(
        EventId = 3,
        Level = LogLevel.Error,
        Message = "{projectName}: Package {packageId} uses pre-release version {version}."
    )]
    public static partial void UsesPreReleaseVersion(
        this ILogger<NoPreReleaseNuGetPackages> logger,
        string projectName,
        string packageId,
        string version
