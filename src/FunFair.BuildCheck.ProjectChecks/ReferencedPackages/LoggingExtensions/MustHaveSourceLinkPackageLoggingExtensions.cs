...
internal static partial class MustHaveSourceLinkPackageLoggingExtensions
{
    ...
    public static partial void DoesNotReferencePackageOrHistoricalPackage(this ILogger<MustHaveSourceLinkPackage> logger,
                                                                          string projectName,
                                                                          string packageId,
    ...
    public static partial void ReferencesBothPackageAndHistoricalPackage(this ILogger<MustHaveSourceLinkPackage> logger,
                                                                         string projectName,
                                                                         string packageId,
                                                                         string historicalPackageId);
}