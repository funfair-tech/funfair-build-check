...
internal static partial class ShouldNotReferenceAllMetaPackagesInPackableProjectsLoggingExtensions
{
    ...
    public static partial void DoNotReferenceMetaPackageInPackableProjects(this ILogger<ShouldNotReferenceAllMetaPackagesInPackableProjects> logger, string projectName, string packageId);
}
