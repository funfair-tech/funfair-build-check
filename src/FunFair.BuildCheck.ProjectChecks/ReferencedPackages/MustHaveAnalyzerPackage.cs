...
public abstract class MustHaveAnalyzerPackage : IProjectCheck
{
    ...
    {
        return StringComparer.OrdinalIgnoreCase.Equals(x: packageId, y: "Microsoft.NET.Test.Sdk")
            || StringComparer.OrdinalIgnoreCase.Equals(x: packageId, y: "xunit.runner.visualstudio");
    }
