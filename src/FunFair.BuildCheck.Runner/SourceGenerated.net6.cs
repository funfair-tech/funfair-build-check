...
internal static partial class SourceGenerated
{
    ...
    private static readonly Regex RegexProjectReference = new(pattern: PROJECT_REFERENCE_REGEX, options: PROJECT_REFERENCE_OPTIONS, matchTimeout: TimeoutTimeSpan);
