...
internal static class Setup
{
    ...
    {
        return services.AddProjectCheck<XmlDocumentationFileRequiredPolicy>().AddProjectCheck<XmlDocumentationFileProhibitedPolicy>();
    }
    ...
    {
        return repositorySettings.IsCodeAnalysisSolution ? services : services.AddProjectCheck<MustHaveFunFairCodeAnalysisPackage>();
    }
    ...
    {
        return repositorySettings.MustHaveEnumSourceGeneratorAnalyzerPackage ? services : services.AddProjectCheck<MustHaveEnumSourceGeneratorAnalyzerPackage>();
    }
