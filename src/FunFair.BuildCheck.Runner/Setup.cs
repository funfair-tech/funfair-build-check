...
internal static class Setup
{
    ...
    {
        return services
            .AddProjectCheck<DoesNotReferenceByDll>()
    ...
    {
        return services
            .AddProjectCheck<MustHaveSourceLinkPackage>()
    ...
    private static IServiceCollection XmlDocumentationProjectSettings(
        this IServiceCollection services
    )
    {
        return services
            .AddProjectCheck<XmlDocumentationFileRequiredPolicy>()
    ...
    private static IServiceCollection StaticCodeAnalysis(
        this IServiceCollection services,
        IRepositorySettings repositorySettings
    )
    {
        return services
            ...
            .AddProjectCheck<MustHaveCsharpierPackage>()
    ...
    private static IServiceCollection AddEnumSourceGeneratorAnalyzerPackage(
        this IServiceCollection services,
        IRepositorySettings repositorySettings
    )
    {
    ...
    private static IServiceCollection AddUnitTestAnalysers(
        this IServiceCollection services,
        IRepositorySettings repositorySettings
    )
    {
        ...
        return services
            .AddProjectCheck<UsingNSubstituteMustIncludeAnalyzer>()
    ...
    private static IServiceCollection AddSolutionCheck<
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T
    >(this IServiceCollection services)
